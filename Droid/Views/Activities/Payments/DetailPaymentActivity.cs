...
namespace ComPact.Droid.Payments
{
	...
	public class DetailPaymentActivity : BaseActivity
	{
		...
		TextView _titlePaymentTextView;
		...
		protected override void OnResume()
		{
			...
			_titlePaymentTextView.Text = Payment.Name;
		...
		void FindViews()
		{
			...
			_titlePaymentTextView = FindViewById<TextView>(Resource.Id.activityDetailPaymentTitleTextView);
